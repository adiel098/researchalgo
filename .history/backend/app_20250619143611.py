...
from .# הגדר נתיב מיוחד לקבצי static/js ו-static/css
...
def serve_css(filename):
    return send_from_directory(os.path.join(app.static_folder, 'static/css'), filename)santa_claus_problem import Instance, AllocationBuilder, divide, santa_claus
