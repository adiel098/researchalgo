    ...
    <div className="about-section">
      ...
      <div className="card mb-4">
        ...
        <div className="card-body">
          <div className="row">
            <div className="col-md-6">
              <h4>Roey Shmilovitch</h4>
              <ul className="list-unstyled">
                <li>
                  <i className="bi bi-envelope me-2"></i>
                  <strong>Email:</strong> roey.shmilovitch@example.com
                </li>
                <li>
                  <i className="bi bi-linkedin me-2"></i>
                  <strong>LinkedIn:</strong> linkedin.com/in/roey-shmilovitch
                </li>
                <li>
                  <i className="bi bi-github me-2"></i>
                  <strong>GitHub:</strong> github.com/roeyshmilovitch
                </li>
              </ul>
            </div>
            <div className="col-md-6">
              ...
              <ul className="list-unstyled">
                <li>
                  <i className="bi bi-envelope me-2"></i>
                  <strong>Email:</strong> adiel.halevi@example.com
                </li>
                <li>
                  <i className="bi bi-linkedin me-2"></i>
                  <strong>LinkedIn:</strong> linkedin.com/in/adiel-halevi
                </li>
                <li>
                  <i className="bi bi-github me-2"></i>
                  <strong>GitHub:</strong> github.com/adielhalevi
                </li>
              </ul>
            </div>
          </div>
