    ...
    <div className="home-container">
      <div className="jumbotron p-5 bg-light rounded">
        ...
        <div className="alert alert-info p-3 mb-4">
          <h4 className="alert-heading"><strong>Restricted Assignment Case</strong></h4>
          <p>
            <strong>The paper we worked on focuses specifically on the restricted assignment case</strong> of the Santa Claus Problem, where:
          </p>
          <ul>
            <li><strong>Each present has a fixed intrinsic value</strong> - the same value for all kids who can receive it</li>
            <li>Some kids may be <strong>unable to receive certain presents</strong> (indicated by a valuation of 0)</li>
            <li>If a kid can receive a present, they value it at its fixed intrinsic value</li>
            <li>This creates a binary constraint: either a kid can receive a present (at its fixed value) or cannot receive it at all</li>
          </ul>
          <p className="mb-0">
            This restriction simplifies the problem while maintaining its computational complexity, making it an interesting case for algorithm design.
          </p>
        </div>
        <p className="mb-4">
